  ...
  return (
    <div className="App">
      <div className="background-container">
        <img
          className="background-container-img"
          src="/react-weather-app/public/imgs/bg-1.jpg"
        />
        <img
          className="background-container-img"
          src="/react-weather-app/public/imgs/bg-3.jpg"
        />
        <img
          className="background-container-img"
          src="/react-weather-app/public/imgs/bg-4.jpg"
        />
        <img
          className="background-container-img"
          src="/react-weather-app/public/imgs/bg-6.jpg"
        />
      </div>
